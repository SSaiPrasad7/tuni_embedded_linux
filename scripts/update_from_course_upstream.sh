...
: ${GITURL_BASE_SSH:="git@course-gitlab.tuni.fi:comp.ce.460-real-time-systems_2022-2023"}
: ${GITURL_BASE_HTTPS:="https://course-gitlab.tuni.fi/comp.ce.460-real-time-systems_2022-2023"}
